...
export const translations = {
    en: {
        ...
        paper: {
            ...
            variantCount: "Variants per Question",
            variantCountHint: "More than 1 variant suits intensive training with few selected items",
        ...
        settings: {
            ...
            ai: {
                ...
                thinking: {
                    ...
                    levelDefault: "Model default (dynamic)",
                    levelOff: "Off (fastest)",
                    levelLow: "Low (~2K tokens)",
                    levelMedium: "Medium (~8K tokens)",
                    levelHigh: "High (~24K tokens)",
                },
        ...
        settings: {
            ...
            ai: {
                ...
                thinking: {
                    ...
                    backfill: "批量补全",
                    levelDefault: "模型默认（动态）",
                    levelOff: "关闭（最快）",
                    levelLow: "低（约 2K tokens）",
                    levelMedium: "中（约 8K tokens）",
                    levelHigh: "高（约 24K tokens）",
                },
                azureEndpointPlaceholder: "https://your-resource.openai.azure.com",
